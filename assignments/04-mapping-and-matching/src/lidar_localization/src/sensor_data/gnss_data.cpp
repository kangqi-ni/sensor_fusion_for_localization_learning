...
//静态成员变量必须在类外初始化
double lidar_localization::GNSSData::origin_longitude = 8.390455335332829;
double lidar_localization::GNSSData::origin_latitude = 48.98265761537226;
double lidar_localization::GNSSData::origin_altitude = 116.3964120701376;
...
void GNSSData::InitOriginPosition() {
    ...
    // std::cout << "latitude longiture altitude:\n";
    // std::cout << latitude << ' ' << longitude << ' ' << altitude << std::endl;

    // geo_converter.Reset(latitude, longitude, altitude);
    geo_converter.Reset(48.98265761537226, 8.390455335332829, 116.3964120701376);
